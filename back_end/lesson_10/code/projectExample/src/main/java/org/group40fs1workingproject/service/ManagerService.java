...
import org.group40fs1workingproject.repository.ManagerRepository;
import org.group40fs1workingproject.repository.RoleRepository;
import org.group40fs1workingproject.service.util.ManagerConverter;
...
public class ManagerService {
    ...
    public ManagerCreateResponseDto createManager(ManagerCreateRequestDto request) {
        if (repository.findByEmail(request.getEmail()).isEmpty()) {
            ...
            throw new RuntimeException("Manager with email " + request.getEmail() + " is already exist");
        }
    }
